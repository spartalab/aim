...
if(isIntersectionT == "FALSE"):
    ...
    oneLaneGreen = "FALSE"
    lanes = 2
    ratio_right_turn = 0.0  # must stay zero
    ratio_straight_turn = 0.6  # The rest are turning, either left or right (depanding on the incomind direction). Those coming from south (can't continue straight) turn 50% left and 50% right (this is hardcoded in the simulator)
